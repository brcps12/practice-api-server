...
if __name__ == '__main__':
    ...
    print(create_command(0, 'OPEN'))

    action([
        create_command(0, 'OPEN')
    ])
    ...
    action([
        create_command(0, 'ENTER', [3, 5])
    ])

    action([
        create_command(0, 'CLOSE')
    ])
    ...
    action([
        create_command(0, 'EXIT', [4, 5])
    ])

    action([
        create_command(0, 'ENTER', [1, 2])
    ])
